        ...
        <Container>
          ...
          <Navbar.Collapse id="responsive-navbar-nav ">
            <div className="links ms-auto">
              <Nav className=" links">
                <Link to="/blog" className="links"> Sobre Alité</Link>
                <Link to="/terminos_y_condiciones" className="links"> Términos y condiciones</Link>


                <div className="ms-1 text-start ">
                  <a target="_blank" rel="noopener noreferrer" href="https://www.twitter.com" className="links">
                  ...
                  <a target="_blank" rel="noopener noreferrer" href="https://www.instagram.com" className="links">
